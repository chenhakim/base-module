...
namespace Module\GoogleAdmobSsv\GoogleAdmobSsv;
...
class Signature
{
     ...
     * @var array
     */
    private $ret_verify = ['code'=> 0, 'message'=> 'success!'];

    /**
     * AdMob 密钥服务器地址
     * @var string
     */
    private $keys_url = 'https://www.gstatic.com/admob/reward/verifier-keys.json';
     ...
     */
    public function __construct($key_url = '', $query_string='')
    {
    ...
    private function parseQueryString()
    {
        ...
        // publicKey
        $this->obj_publicKey = new PublicKey($this->keys_url, $this->key_id);
    }
